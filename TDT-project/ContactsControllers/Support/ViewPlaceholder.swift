...
enum ViewPlaceholderTitle: String {
  case denied = "TDT doesn't have access to your contacts"
  case empty = "You don't have any TDT Users yet."
  case emptyChat = "You don't have any active conversations yet."
}

enum ViewPlaceholderSubtitle: String {
  case denied = "Please go to your iPhone Settings –– Privacy –– Contacts. Then select ON for TDT."
